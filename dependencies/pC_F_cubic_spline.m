% function F = pC_F_cubic_spline(el_pos,d,cond,cond_top,this_tol, saveFolder)
...
% full_filename = [saveFolder filesep 'Fcs' tfilename '.mat'];
% 
% try,
...
function F = pC_F_cubic_spline(el_pos,d,cond,cond_top,tol)
