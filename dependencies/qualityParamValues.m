...
param.maxWvBaselineFraction = 0.75; % maximum absolute value in waveform baseline
    % should not exceed this fraction of the waveform's abolute peak value
param.maxScndPeakToTroughRatio_noise = 1.2; % peak must be less than this x the trough 
